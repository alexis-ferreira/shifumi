...
let scoreUser=document.getElementById('userScore').innerHTML;
// let scoreCpu=document.getElementById('cpuScore').innerHTML;

let h2=document.getElementById("h2").innerHTML;

// console.log(typeof scoreUser);

scoreUser=parseInt(scoreUser);
    ...
    if(cpuChoice == 2){
        ...
        switch(feuilleClick){
            case feuilleClick:
                if(cpuChoice == 3){
                    document.getElementById('cpu').src=("/img/ciseaux.png");
                    document.getElementById("h2").innerHTML="Ciseaux ! "+userName+" a perdu !";
                    document.getElementById("h2").style.backgroundColor='red';
